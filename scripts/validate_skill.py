...
for required_path in ("scripts/dispatch.py", "scripts/bootstrap_agents.py", "references/routing.md", "references/learning.md", "references/contracts.md", "references/parallel-safety.md", "agents/openai.yaml"):
